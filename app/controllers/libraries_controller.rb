...
class LibrariesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @library.save
        format.html { redirect_to library_url(@library), notice: notice_t(@library, :create) }
  ...
  def update
    respond_to do |format|
      if @library.update(library_params)
        format.html { redirect_to library_url(@library), notice: notice_t(@library, :update) }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to libraries_url, notice: notice_t(@library, :delete) }
