...
class DesignersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create designer" do
    assert_difference("Designer.count") do
      post designers_url, params: { designer: { name: @designer.name, website: @designer.website } }
    end
  ...
  test "should update designer" do
    patch designer_url(@designer), params: { designer: { name: @designer.name, website: @designer.website } }
